	...
	*/
	...
	return &GenesisState{
		...
		ChainInfo: ChainInfo{
			...
			ChainAdministratorKey: "cosmos1zqhm77enzuckqtnlul7f3qg567swkyzmqjkk5r",
			ChainKey:              "cosmos1cmvty4l0kzrmscpusn2t59ettmrp50t23hc7v8",
			Country:               "Germany",
			InitStatus:            false,
			ChainName:             "university_chain_de",
		},
