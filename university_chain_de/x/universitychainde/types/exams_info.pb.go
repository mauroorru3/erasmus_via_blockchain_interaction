...
// source: universitychainde/exams_info.proto
...
func init() {
	proto.RegisterType((*ExamsInfo)(nil), "university_chain_de.universitychainde.ExamsInfo")
}

func init() {
	proto.RegisterFile("universitychainde/exams_info.proto", fileDescriptor_d0fe6f1be5198d63)
}
