...
// source: universitychainde/erasmus_career.proto
...
func init() {
	proto.RegisterType((*ErasmusCareer)(nil), "university_chain_de.universitychainde.ErasmusCareer")
}

func init() {
	proto.RegisterFile("universitychainde/erasmus_career.proto", fileDescriptor_d28aa2a5b57a27ec)
}
