...
// x/universitychainde module sentinel errors
var (
	...
	ErrTaxesPaidHomeUniversity         = sdkerrors.Register(ModuleName, 1153, "taxes have already been paid in the home university")
)
