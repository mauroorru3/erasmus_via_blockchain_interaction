...
export interface StoredStudentUnipi {
  index: string;
...
const baseStoredStudentUnipi: object = { index: "" };

export const StoredStudentUnipi = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): StoredStudentUnipi {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseStoredStudentUnipi } as StoredStudentUnipi;
  ...
  fromJSON(object: any): StoredStudentUnipi {
    const message = { ...baseStoredStudentUnipi } as StoredStudentUnipi;
  ...
  toJSON(message: StoredStudentUnipi): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<StoredStudentUnipi>): StoredStudentUnipi {
    const message = { ...baseStoredStudentUnipi } as StoredStudentUnipi;
    if (object.index !== undefined && object.index !== null) {
