...
import (
	...
	"university_chain_de/docs"
	universitychaindemodule "university_chain_de/x/universitychainde"
	universitychaindemodulekeeper "university_chain_de/x/universitychainde/keeper"
	universitychaindemoduletypes "university_chain_de/x/universitychainde/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "cosmos"
	Name                 = "university_chain_de"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		universitychaindemodule.AppModuleBasic{},
		// this line is used by starport scaffolding # stargate/app/moduleBasic
	)

	// module account permissions
	maccPerms = map[string][]string{
		universitychaindemoduletypes.ModuleName: nil,
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		universitychaindemoduletypes.StoreKey,
	...
	app.UniversitychaindeKeeper = *universitychaindemodulekeeper.NewKeeper(
		...
		keys[universitychaindemoduletypes.MemStoreKey],
	...
	ibcRouter.AddRoute(universitychaindemoduletypes.ModuleName, universitychaindeModule)
	...
	app.mm.SetOrderBeginBlockers(
		...
		universitychaindemoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(universitychaindemoduletypes.ModuleName)
