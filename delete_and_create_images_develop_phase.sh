...
sudo docker build --no-cache -f Dockerfile-university_chain_itd . -t university_chain_itd_i; 
cd ..;
...
sudo docker build --no-cache -f Dockerfile-university_chain_ded . -t university_chain_ded_i; 
cd ..;
