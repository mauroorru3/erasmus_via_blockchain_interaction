...
export interface ProfessorsExamsUniroma1 {
  examName: string;
...
const baseProfessorsExamsUniroma1: object = {
  examName: "",
  professorName: "",
  professorId: "",
  professorKey: "",
...
export const ProfessorsExamsUniroma1 = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): ProfessorsExamsUniroma1 {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseProfessorsExamsUniroma1,
    } as ProfessorsExamsUniroma1;
  ...
  fromJSON(object: any): ProfessorsExamsUniroma1 {
    const message = {
      ...baseProfessorsExamsUniroma1,
    } as ProfessorsExamsUniroma1;
  ...
  toJSON(message: ProfessorsExamsUniroma1): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<ProfessorsExamsUniroma1>
