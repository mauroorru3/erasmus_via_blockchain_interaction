...
export interface UniversityInfoUnipi {
...
const baseUniversityInfoUnipi: object = {
  nextStudentId: 0,
  secretariatKey: "",
  universityKey: "",
  caiKey: "",
...
export const UniversityInfoUnipi = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): UniversityInfoUnipi {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseUniversityInfoUnipi } as UniversityInfoUnipi;
  ...
  fromJSON(object: any): UniversityInfoUnipi {
    const message = { ...baseUniversityInfoUnipi } as UniversityInfoUnipi;
  ...
  toJSON(message: UniversityInfoUnipi): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<UniversityInfoUnipi>): UniversityInfoUnipi {
    const message = { ...baseUniversityInfoUnipi } as UniversityInfoUnipi;
    if (object.nextStudentId !== undefined && object.nextStudentId !== null) {
