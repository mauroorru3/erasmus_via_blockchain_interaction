...
export interface HubMsgSendErasmusIndexResponse {
  /** @format int32 */
  status?: number;
}
...
export type HubMsgSendExtendErasmusPeriodResponse = object;

export interface HubMsgSendFinalErasmusDataResponse {
  /** @format int32 */
  status?: number;
}
