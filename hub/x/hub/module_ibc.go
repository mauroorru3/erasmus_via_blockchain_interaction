...
func (am AppModule) OnRecvPacket(
	...
	case *types.HubPacketData_ErasmusStudentPacket:
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeErasmusStudentPacket,
	...
	case *types.HubPacketData_EndErasmusPeriodRequestPacket:
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeEndErasmusPeriodRequestPacket,
				sdk.NewAttribute(sdk.AttributeKeyModule, types.ModuleName),
				sdk.NewAttribute(types.AttributeKeyAckSuccess, fmt.Sprintf("%t", err != nil)),
			),
		)
	...
	case *types.HubPacketData_ExtendErasmusPeriodPacket:
	...
	case *types.HubPacketData_ErasmusRestictedDataPacket:
